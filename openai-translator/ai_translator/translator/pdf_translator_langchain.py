...
class PDFTranslatorLangChain:
    def __init__(self, model_name: str, deployment_name: str, api_type: str):
        self.translate_chain = TranslationChain(model_name=model_name, deployment_name=deployment_name,
                                                api_type=api_type)
